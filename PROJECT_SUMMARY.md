...
- **File:** `share/lua/extensions/vlc-infinity.lua`
- **Size:** ~430 lines of Lua code
- **Functionality:**
...
### Main Menu Options
1. **Browse Channels:** Search and filter IPTV channels by country, category, or name
2. **Browse Movies:** Search and filter public-domain movies by title and genre
3. **Favorites:** Quick access to saved favorite channels
4. **History:** Replay recently watched content
5. **EPG:** (Coming Soon) Electronic Program Guide
6. **Settings:** (Coming Soon) Configuration options
